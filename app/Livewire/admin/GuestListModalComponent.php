...
class GuestListModalComponent extends Component
{
    ...
    public function mount()
    {
        ...
        $this->guests = [
            ['name' => 'John Doe', 'plate_number' => 'BEE 123', 'time_in' => '10:15 AM'],
            ['name' => 'Jane Smith', 'plate_number' => 'CAR 456', 'time_in' => '10:20 AM'],
            ['name' => 'Peter Jones', 'plate_number' => 'TRK 789', 'time_in' => '10:32 AM'],
        ];
    }
