...
<body>
    ...
    <div class="content">
        ...
        <p>This email is to inform you that you currently have <strong>{{ $violationCount }} approved parking
                violations</strong> on your account.</p>

        <p><strong>Due to this violation threshold being reached, your parking access has been temporarily
                restricted.</strong> You will be unable to enter parking areas until this matter is resolved.</p>
        ...
        <div class="warning-box">
            <strong>Note:</strong> This restriction will remain in effect until your violation count falls below the
            threshold or you receive administrative approval.
        </div>
