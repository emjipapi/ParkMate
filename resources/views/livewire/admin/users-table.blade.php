<div x-data="{
    ...
    <template x-if="showAlert">
        <div class="alert alert-warning text-center position-fixed top-0 start-50 translate-middle-x mt-3 shadow" style="z-index: 2000;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-3 w-100 justify-content-end">
            <i 
                :class="check2 ? 'bi bi-check2-all text-primary' : 'bi bi-check2-all'" 
            ...
            <i class="bi bi-trash-fill" 
               :class="selectedIds.length > 0 ? 'text-danger' : 'text-muted'" 
               style="transform: scale(1.2); cursor: pointer;"
               @click="triggerDelete()"
    ...
    <div class="alert alert-success text-center position-fixed top-0 start-50 translate-middle-x mt-3 shadow" style="z-index: 2000;">
        {{ session('message') }}
    </div>
@endif
    </div>
