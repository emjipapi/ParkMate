                                        ...
                                        <div class="border rounded p-3 h-100">
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    wire:click="saveElementPositions" id="enable-{{ $element }}">
                                            ...
                                            <div
                                                class="{{ empty($config['enabled']) ? 'opacity-50 pointer-events-none' : '' }}">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <input type="number" class="form-control form-control-sm" min="8"
                                                            max="72" step="1"
                                                ...
                                                <div class="mt-3">
                                                    <label class="form-label small d-block mb-1 fw-semibold">Quick
                                                        Positions</label>
                                                    <div class="row g-1">
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-start"
                                                                wire:click="setQuickPosition('{{ $element }}', 'top_left')">↖
                                                                Top Left</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-center"
                                                                wire:click="setQuickPosition('{{ $element }}', 'top_center')">↑
                                                                Top Center</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-end"
                                                                wire:click="setQuickPosition('{{ $element }}', 'top_right')">↗
                                                                Top Right</button>
                                                        </div>
                                                        ...
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-start"
                                                                wire:click="setQuickPosition('{{ $element }}', 'center_left')">←
                                                                Left</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-center"
                                                                wire:click="setQuickPosition('{{ $element }}', 'center')">⊙
                                                                Center</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-end"
                                                                wire:click="setQuickPosition('{{ $element }}', 'center_right')">→
                                                                Right</button>
                                                        </div>
                                                        ...
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-start"
                                                                wire:click="setQuickPosition('{{ $element }}', 'bottom_left')">↙
                                                                Bottom Left</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-center"
                                                                wire:click="setQuickPosition('{{ $element }}', 'bottom_center')">↓
                                                                Bottom Center</button>
                                                        </div>
                                                        <div class="col-4">
                                                            <button type="button"
                                                                class="btn btn-outline-secondary btn-sm w-100 text-end"
                                                                wire:click="setQuickPosition('{{ $element }}', 'bottom_right')">↘
                                                                Bottom Right</button>
                                                        </div>
                                                    </div>
                                                </div>
