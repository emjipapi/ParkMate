                ...
                <div class="card mb-4" id="vehicle-{{ $vehicle['id'] ?? $vehicle['uid'] }}" wire:key="vehicle-{{ $vehicle['uid'] }}">
                    <div class="card-body">
                        ...
                        <div class="row mb-2 align-items-end">
                            ...
                            <div class="col-md">
                                ...
                                @if(isset($vehicles[$index]['rfid_tags'][1]))
                                    <div class="input-group">
                                        <input type="text" wire:model="vehicles.{{ $index }}.rfid_tags.1" class="form-control" maxlength="10">
                                        <button type="button" wire:click="removeRfidTag({{ $index }}, 1)" class="btn btn-outline-danger">&times;</button>
                                    </div>
                                @else
                                    <button type="button" wire:click="addRfidTag({{ $index }})" class="btn btn-sm btn-outline-primary">+ Add Tag</button>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-end">
                            ...
                            <div class="col-md">
                                ...
                                @if(isset($vehicles[$index]['rfid_tags'][2]))
                                    <div class="input-group">
                                        <input type="text" wire:model="vehicles.{{ $index }}.rfid_tags.2" class="form-control" maxlength="10">
                                        <button type="button" wire:click="removeRfidTag({{ $index }}, 2)" class="btn btn-outline-danger">&times;</button>
                                    </div>
                                @else
                                    @if(isset($vehicles[$index]['rfid_tags'][1]))
                                        <button type="button" wire:click="addRfidTag({{ $index }})" class="btn btn-sm btn-outline-primary">+ Add Tag</button>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                @if(count($vehicles) > 1)
                                    <button type="button" wire:click="removeVehicleRow({{ $index }})" class="btn btn-danger w-100">Remove Vehicle</button>
                                @else
