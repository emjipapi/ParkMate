    ...
    <form wire:submit.prevent="update">
        ...
        <div class="permissions-wrapper position-relative">
                ...
                <div class="ms-4 mt-2">
                    <div class="form-check">
                        ...
                        <label class="form-check-label">Analytics Dashboard
                            <i class="bi bi-info-circle ms-1 text-secondary" wire:ignore data-bs-toggle="tooltip"
                                title="{{ $allPermissions['analytics_dashboard'] ?? '' }}" tabindex="0"
                                role="button"></i>
                        </label>
                    </div>
                    <div class="form-check">
                        ...
                        <label class="form-check-label">Live Attendance<i class="bi bi-info-circle ms-1 text-secondary"
                                wire:ignore data-bs-toggle="tooltip"
                                title="{{ $allPermissions['live_attendance'] ?? '' }}" tabindex="0"
                                role="button"></i></label>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="manage_guest_tag"
                            data-group="dashboard" wire:model="permissions" wire:change="syncParent('dashboard')">
                        <label class="form-check-label">Manage Guest Tags<i
                                class="bi bi-info-circle ms-1 text-secondary" wire:ignore data-bs-toggle="tooltip"
                                title="{{ $allPermissions['manage_guest_tag'] ?? '' }}" tabindex="0"
                                role="button"></i></label>
                    </div>
                </div>
            </div>
                ...
                <div class="ms-4 mt-2">
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="manage_map"
                            data-group="parking_slots" wire:model="permissions"
                            wire:change="syncParent('parking_slots')">
            ...
            <div class="mb-4">
                ...
                <div class="ms-4 mt-2">
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="users_table"
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="admins_table"
                            data-group="users" wire:model="permissions" wire:change="syncParent('users')">
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="guests_table"
                            data-group="users" wire:model="permissions" wire:change="syncParent('users')">
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="create_user"
                            data-group="users" wire:model="permissions" wire:change="syncParent('users')">
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="create_admin"
                            data-group="users" wire:model="permissions" wire:change="syncParent('users')">
                    ...
                    <div class="form-check">
                        <input class="form-check-input group-child" type="checkbox" value="edit_admin"
                            data-group="users" wire:model="permissions" wire:change="syncParent('users')">
