<div class="w-full" style="max-width: 1200px; margin: auto;">
    ...
    <div class="mb-4 flex flex-wrap gap-4 items-end">
        ...
        <div class="flex-1 min-w-48">
            ...
            <select id="dateSelect" wire:model.live="selectedDate" wire:loading.attr="disabled" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed">
        ...
        <div class="flex-1 min-w-48">
            ...
            <select id="chartType" wire:model.live="chartType" wire:loading.attr="disabled" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed">
