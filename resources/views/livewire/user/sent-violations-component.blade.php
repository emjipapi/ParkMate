{{-- resources\views\livewire\user\sent-violations-component.blade.php --}}
<div>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped custom-table d-none d-sm-table">
            ...
            <tbody>
                    ...
                    <td class="px-3 py-3 small">
                        ...
                        <div class="d-flex flex-column" style="gap: 0.25rem;">
                            ...
                            <a href="{{ $thumbUrl }}" target="_blank" class="d-inline-block mb-1">
                                <img src="{{ $thumbUrl }}" alt="evidence"
                                    style="max-width:90px; max-height:60px; object-fit:cover; border-radius:4px; border:1px solid #eee;">
                            </a>
                            @else
                            ...
                            <div>
                                ...
                                <a href="{{ $reportedUrl }}" target="_blank"
                                    class="text-decoration-underline text-primary me-2">View</a>
                                @endif
                            </div>
                        </div>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="8" class="px-3 py-3 text-center text-muted">Wow, such empty.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="mobile-cards d-block d-sm-none">
            ...
            <article class="bg-white border rounded p-3 shadow-sm mb-3">
                ...
                <div class="small">
                    ...
                    <!-- Message -->
                    <div class="d-flex mb-2">
                        <div class="fw-bold text-muted" style="min-width: 110px; flex-shrink: 0;">Message:</div>
                        <div class="text-dark text-break">
                            {{ Str::limit($violation->latestMessage->message ?? '—', 120) }}
                        </div>
                    </div>
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="text-dark">
                            {{ $violation->license_plate ?? 'N/A' }}
                            @if($violation->vehicle)
                            <div class="small text-muted">({{ $violation->vehicle->body_type_model ?? 'Unknown Model'
                                }})</div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="text-dark">
                            ...
                            <a href="{{ $thumbUrl }}" target="_blank" class="d-inline-block mb-2">
                                <img src="{{ $thumbUrl }}" alt="evidence"
                                    style="max-width:120px; max-height:80px; object-fit:cover; border-radius:4px; border:1px solid #eee;">
                            </a>
                            <div>
                                <a href="{{ $reportedUrl }}" target="_blank"
                                    class="text-decoration-underline text-primary small">View Full Size</a>
                            </div>
                            @else
                            <span class="text-muted">No evidence</span>
                            @endif
